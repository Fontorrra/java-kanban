...
public class HttpTaskManager extends FileBackedTasksManager {
    ...
    protected void load() {
        ...
        } catch (IOException | InterruptedException exception) { throw new HttpLoadException(); }
        addTasks(tasks);
        addTasks(epics);
        addTasks(subtasks);
    }
    ...
    protected void save() {
        ...
        } catch (IOException | InterruptedException exception) { throw new HttpSaveException(); }
    }
}
